...
int HttpPostRequest(string input)
{
    ...
    std::string strJson = "{";
    strJson += "\"key\" : \"f83daa5918b64c7996e389e0d12e4835\","; //双引号前加／防转仪
    strJson += "\"info\" : ";
    strJson += "\"";
    strJson += input;
    strJson += "\"";
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub = nd.subscribe("voice/stt", 10, arvCallBack);
    ros::Publisher pub = nd.advertise<std_msgs::String>("/voice/tts", 10);
